	...
	public static void main(String[] args) {
		...
		while (!winFlg /* winFlg == falseと同じ意味 */) {
			...
			if (cpuHand == 0) {
				...
				if(myHand == 0) System.out.println("あいこ");
				else if(myHand == 1) System.out.println("負け");
				else if(myHand == 2) {
				...
				else if(myHand == 1) System.out.println("あいこ");
				else if(myHand == 2) System.out.println("負け");
			} else {
				System.out.println("パー！！");
				if(myHand == 0) System.out.println("負け");
				else if(myHand == 1) {
					System.out.println("勝ち");
					winFlg = true;
				}
				else if(myHand == 2) System.out.println("あいこ");
			}
